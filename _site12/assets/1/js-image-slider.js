...
function mcImgSlider(k) {
    for (var T = function (a) {
        ...
        return c
    }, g = "className", h = "getAttribute", i = "opacity", kb = function (a, b) {
        return a[ab](b)
    }, vb = function (a) {
    ...
    }, Kb = document, U = window.requestAnimationFrame, db = window.cancelAnimationFrame, jb = ["webkit", "ms", "o"], cb = 0; cb < jb[d] && !U; ++cb) {
        U = window[jb[cb] + "RequestAnimationFrame"];
        db = window[jb[cb] + "CancelAnimationFrame"]
    }
    var c = "style", y = "display", G = "visibility", j = "width", z = "height", Y = "top", P = "background", r = "undefined", x = "marginLeft", w = "appendChild", q = "parentNode", o = "nodeName", Q = "innerHTML", X = "offsetWidth", D = setTimeout, L = clearTimeout, F = "indexOf", N = "setAttribute", ib = "removeChild", E = function () {
        this.d = [];
        this.b = null
    }, rb = function () {
    ...
    var l = new E, nb = function () {
        ...
        return a.join("")
    }, b = {a: 0, e: "", d: 0, c: 0, b: 0}, a, f, v, B, V, O, W, n, p, Z, K, t, H, J, s, hb, S, R, eb, e, I, m = null, Cb = function () {
    ...
    }, yb = ["$1$2$3", "$1$2$3", "$1$24", "$1$23", "$1$22"], sb = function () {
        if (b.b != 2) {
            b.b = 1;
            L(s);
            s = null
        ...
        var f;
        if (a.l)f = T(a.l);
        if (f)for (var h = kb(f, "*"), e = 0; e < h[d]; e++)h[e][g] == "thumb" && u.push(h[e]);
        var c = u[d];
        if (c) {
            while (c--) {
                u[c].on = 0;
        ...
        return b.join("")
    }, xb = [/(?:.*\.)?(\w)([\w\-])[^.]*(\w)\.[^.]+$/, /.*([\w\-])\.(\w)(\w)\.[^.]+$/, /^(?:.*\.)?(\w)(\w)\.[^.]+$/, /.*([\w\-])([\w\-])\.com\.[^.]+$/, /^(\w)[^.]*(\w)$/], A = function (b) {
    ...
    tb.prototype = {c: function () {
        ...
        this.i();
        var p = this.v();
        if (e[b.a][o] == "IMG")b.e = e[b.a]; else b.e = kb(e[b.a], "img")[0];
        ...
        if (!I) {
            I = A("sliderInner");
            f[w](I);
            if (rb() >= 300)f[c].borderRadius = I[c].borderRadius = "0px"
        }
        I[Q] = "";
        var d = i ? i : a.n();
        ...
        for (var q = {c: a.c / 1.3}, k = 0, o = a.g * 2; k < o; k++) {
            for (var h = k, l = 0; l < a.m; l++) {
                if (h >= 0 && h < a.g) {
                    var m = f[l][h];
                    lb(q, b[d], p, m, {width: 0, height: 0, opacity: 0}, {width: m.w, height: m.h, opacity: 1}, n);
                    p++
                }
                h--
            }
    ...
    var gb = function () {
        var a = T(k.sliderId);
        if (a && C(a)[d] && a.offsetHeight)m = new tb(a); else D(gb, 500)
    };
    fb();
    var Gb = function (c) {
        var a = false;
